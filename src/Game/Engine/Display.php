...
EOHEAD;
        ...
        foreach ($this->results as $result) {
            ...
            $resultsByMatch .= '<td>'.$playerA['scissors'].'</td>'.PHP_EOL.'<td>'.$playerA['paper'].'</td>'.PHP_EOL.'<td>'.$playerA['rock'].'</td>'.PHP_EOL;
            ...
            $resultsByMatch .= '<td>'.$playerB['scissors'].'</td>'.PHP_EOL.'<td>'.$playerB['paper'].'</td>'.PHP_EOL.'<td>'.$playerB['rock'].'</td>'.PHP_EOL;
